  ...
  <nav class="navbar navbar-default navbar-fixed-top text-center navbarcolor">
    ...
    <section class="section padding bg-white text-center">
      <div class="container max-600">
        <div class="row">
            <div class="col-md-12">
              <h3 class="bold">Learn everything on Augmented Reality, user cases, trends & latest news.</h3>
            </div>
            <div class="col-md-12">
    ...
    <section id="article" class="section p-t-0">
      <div class="container">
        <div class="row-fluid">
          <div class="mdl-card mdl-card-article blog col-sm-12 p-0 m-t-0">
            <div class="mdl-card__title margin">
                <h3 class="bold mdl-card__title-text">How Augmented Reality is changing our lives and how that affect us!</h3>
              </div>
              <div class="mdl-card__supporting-text">
                <p>In a perfect world, we would be doing all of our commicating in person. In our moderm, increasingly connected world, however. In a perfect world, we would be doing all of our commicating in person. In a perfect world, we would be doing all of our commicating in person</p>
                <p>In a perfect world, we would be doing all of our commicating in person. In our moderm, increasingly connected world, however. In a perfect world, we would be doing all of our commicating in person. In a perfect world, we would be doing all of our commicating in person</p>
                <p>In a perfect world, we would be doing all of our commicating in person. In our moderm, increasingly connected world, however. In a perfect world, we would be doing all of our commicating in person. In a perfect world, we would be doing all of our commicating in person</p>
                <p>In a perfect world, we would be doing all of our commicating in person. In our moderm, increasingly connected world, however. In a perfect world, we would be doing all of our commicating in person. In a perfect world, we would be doing all of our commicating in person</p>
                <p>In a perfect world, we would be doing all of our commicating in person. In our moderm, increasingly connected world, however. In a perfect world, we would be doing all of our commicating in person. In a perfect world, we would be doing all of our commicating in person</p>
